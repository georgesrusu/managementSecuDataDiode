...
We can define predictable events as security lack that we are or not acknowledged about concerning our system. Here is a list with some natural person which could be implicated in the hacking action of our client's company system and thus hacking our data diode implementation.
\begin{enumerate}
...
We will detail more about all of this in the following sections.
