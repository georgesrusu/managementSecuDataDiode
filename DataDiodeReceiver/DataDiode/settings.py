"""
Django settings for DataDiode project.
...
SECRET_KEY = 'r#z-8p4x-4l%47hv41hq_u0v!ef2xsp+hx((xk+8^(&=qosq1z'
...
WSGI_APPLICATION = 'DataDiode.wsgi.application'
...
WEBADDRESSRECEIVER="192.168.2.254"
