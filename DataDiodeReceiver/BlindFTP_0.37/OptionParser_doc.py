...
"""
----------------------------------------------------------------------------
OptionParser_doc: Classe pour gérer les options de ligne de commande.
----------------------------------------------------------------------------

Hérite de OptionParser pour modifier son affichage.
...
class OptionParser_doc (OptionParser):
	"""classe héritant d'optparse.OptionParser, qui ajoute l'affichage de
